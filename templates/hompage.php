        ...
        <div class="row">
            <div class="container">
                <div class="col-md-8 col-md-offset-2 text-center heading">
                    ...
                    <p>Our proven solutions help B2B companies to deliver consistently amazing customer experiences that
                        drive satisfaction, retention and advocacy.</p>
                    <p>We enable companies to orchestrate and analyze customer data, insights and interactions – all on
                        one powerful CXM platform.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row top-row">
            <div class="container">
                ...
                <div class="col-md-5 col-sm-5 text-right copy">
                    ...
                    <p>Instantly extract quantitative and qualitative insights that allow you to make educated customer
                        experience decisions. No more watching hundreds of videos to get what you need.</p>
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <div class="col-md-6 col-sm-6 text-left copy">
                    ...
                    <p>Easily invite, register and onboard your testers via email, Slack, IM and message boards, without
                        training or IT involvement. No more professional testers from panel companies.</p>
