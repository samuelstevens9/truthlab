                    ...
                    <div class="container-fluid">
                        <ul class="nav navbar-nav">
                            <li class="<?php if ( ! $the_author && ! isset( $_GET[ 'category' ] ) ) {
								echo ' active ';
							} ?>"><a href="<?php echo $current_url; ?>">All <span class="sr-only">(current)</span></a>
                            </li>
                                        ...
                                        <div class="caption">
                                            <figcaption class="info">
                                                ...
                                                <p class="time"><i class="fa fa-clock-o"
                                                                   aria-hidden="true"></i> <?php echo do_shortcode( '[rt_reading_time]' ); ?>
                                                    minute read |
                                                    By: <?php echo get_the_author_meta( 'display_name' ); ?></p>
